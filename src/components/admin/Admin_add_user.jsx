...
const Admin_add_user = () => {
  return (
    ...
    <div class="grid gap-6 mb-6 md:grid-cols-2">
        ...
        <button type="submit" class=" font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center bg-green-500 hover:bg-green-400 focus:ring-green-800">Add User</button>

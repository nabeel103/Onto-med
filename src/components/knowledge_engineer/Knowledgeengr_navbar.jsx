      ...
      <div className='flex justify-between items-center h-24 max-w-6xl mx-auto px-4 text-gray-300'>
          ...
          <div className={nav ? 'fixed  left-0 top-0 w-[60%] h-screen border-r border-r-gray-100 dark:border-r-gray-900 bg-white dark:bg-black  transition-[left]   ease-in-out duration-500' : 'fixed left-[-100%]'}>
            ...
            <ul className='pt-12 uppercase p-4 text-gray-300'>
              <li className='p-4 border-b text-gray-500 hover:text-black border-gray-300 dark:border-gray-600 dark:hover:text-white  whitespace-nowrap'><Link to = "/knowledgeengr/addrule" onClick={handleNav}><AiFillPlusCircle className='mt-1 mr-1 w-4 h-4 my-auto'/> Rule</Link></li>
              <li className='p-4 border-b text-gray-500 hover:text-black border-gray-300 dark:border-gray-600 dark:hover:text-white  whitespace-nowrap'><Link to = "/knowledgeengr/viewrule" onClick={handleNav}>Knowledge-Base</Link></li>
              <li className='p-4 border-b text-gray-500 hover:text-black border-gray-300 dark:border-gray-600 dark:hover:text-white '><Link to = "/knowledgeengr/viewreport">Reports</Link></li>
